...
def generate_launch_description():
    ...
    urdf_path = os.path.join(base_dir, 'right_hand', 'urdf', 'right_hand_rerun.urdf')
    rviz_config_path = os.path.join(pkg_share, 'rviz', 'right_hand_view.rviz')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=['0', '0', '0', '0', '-1.57', '0', 'world', 'wrist_right_link'],
        ),
        Node(
            package='rviz2',
            executable='rviz2',
